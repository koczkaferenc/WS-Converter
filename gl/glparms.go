...
var (
	...
	// Görgőslácok paramétertáblázata
	GLParms = map[string]map[string]string{
	...
	// Flyer láncok táblázata
	flyerOsztasTab = map[string]string{
		"4": "12,70", "5": "15,88", "6": "19,05", "8": "25,40",
		"10": "31,75", "12": "38,10", "14": "44,45", "16": "50,80",
	}

	// -----------------------------------------------------------
	// Reguláris kifejezések a termékkódokra
	// -----------------------------------------------------------
